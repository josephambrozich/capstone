            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form name="create-comment" id="create-comment" method="post" action="{{url('store-comment')}}">
                        @csrf
                            ...
                            <input style="border: 1px solid #dfdbdb;width: 80%;margin: 5px;border-radius: 10px;padding: 10px;" value='{{$ticket->tags}}' type="text" id="content" name="content" class="form-control" required="">
